...
import org.capiskinserver.security.jwt.JwtUtils;
import org.capiskinserver.security.message.request.LoginRequest;
import org.capiskinserver.security.message.request.SignupRequest;
import org.capiskinserver.security.message.response.JwtResponse;
import org.capiskinserver.security.message.response.MessageResponse;
		...
		if (strRoles == null) {
			...
			strRoles.forEach(role -> {
				...
				case "admin":
					...
					break;
				case "mod":
					Role modRole = roleRepository.findByName(ERole.ROLE_LABORATORY)
							.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
					roles.add(modRole);
