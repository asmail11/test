...
public class EssentialOiController extends RestBaseController {
	...
	@PostMapping("/addEssentialOil/{idCharar}")
	EssentialOilDto addEssentialOil(@RequestBody EssentialOilDto essentialOilDto, @PathVariable long idCharar) {
		return essentialOilManagerService.addEssentialOil(essentialOilDto, idCharar);
	}
	...
	@GetMapping("/findEssentialOilForCharar/{idCharar}")
	EssentialOilDto findEssentialOilForCharar(@PathVariable long idCharar) {
		return essentialOilManagerService.findEssentialOilForCharar(idCharar);
	}

	@DeleteMapping("/deleteEssentialOil/{idEssentialOil}/{idCharar}")
	void deleteEssentialOil(@PathVariable long idEssentialOil, @PathVariable long idCharar) {
		essentialOilManagerService.deleteEssentialOil(idEssentialOil, idCharar);
	}
