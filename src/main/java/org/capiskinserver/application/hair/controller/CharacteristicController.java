...
public class CharacteristicController extends RestBaseController {
	...
	@PostMapping("/addCharacteristic/{idCategory}")
	CharacteristicDto addCharacteristic(@RequestBody CharacteristicDto characteristicDto,
			@PathVariable long idCategory) {
		return characteristicManagerService.addCharacteristic(characteristicDto, idCategory);
	}
